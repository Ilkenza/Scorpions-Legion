...
function Onama() {
  ...
  const para = "text-base md:text-xl text-center text-dcrvena"
  useEffect(() => {
  ...
  return (
    <div
      ...
      <p className={para} data-aos="fade-up" data-aos-delay="150">
        Scorpions Legion je discord zajednica gde se okupljaju CS2 igraci.<br/>
        Server je osnovan 15.06.2023.</p>
        <br/>
        <p className={para} data-aos="fade-up" data-aos-delay="250">Na serveru se prave givavejevi,odrzava se povremeno fastcup, ima<br/>
        dobra ekonomija, self-rolovi,partnership koji radimo samo sa cs2<br/>
        serverima,pravljenje sobe i editovanje iste sobe.</p>
        <br/>
        <p className={para} data-aos="fade-up" data-aos-delay="350">Server je napravljen u cilju da bude sto vise cs2 igraca koji mogu<br/>
